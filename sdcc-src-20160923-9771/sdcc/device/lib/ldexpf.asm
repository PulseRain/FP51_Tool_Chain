...
;x                         Allocated with name '_ldexpf_x_1_25'
;fl                        Allocated with name '_ldexpf_fl_1_26'
;e                         Allocated with name '_ldexpf_e_1_26'
;------------------------------------------------------------
