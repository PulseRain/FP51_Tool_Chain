...
;x                         Allocated with name '_frexpf_x_1_25'
;fl                        Allocated with name '_frexpf_fl_1_26'
;i                         Allocated with name '_frexpf_i_1_26'
;------------------------------------------------------------
