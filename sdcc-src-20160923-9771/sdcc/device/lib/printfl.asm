...
;------------------------------------------------------------
;fmt                       Allocated to stack - _bpx -4
;ap                        Allocated to stack - _bpx +0
;stri                      Allocated to stack - _bpx +1
;buffer                    Allocated with name '_printf_small_buffer_5_40'
;------------------------------------------------------------
...
;	printfl.c:184: _ltoa (val, buffer, radix);
	...
	mov	a,#_printf_small_buffer_5_40
	movx	@dptr,a
	clr	a
	inc	dptr
	movx	@dptr,a
...
;	printfl.c:186: while (*stri)
	mov	r1,#_printf_small_buffer_5_40
00121$:
	mov	a,@r1
	mov	r7,a
	jz	00130$
