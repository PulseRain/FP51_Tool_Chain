...
;------------------------------------------------------------
;c                         Allocated with name '_isgraph_c_1_21'
;------------------------------------------------------------
...
;	isgraph.c:35: return (c > ' ' && c <= '~');
	...
	xrl	b,#0x80
	subb	a,b
	mov	_isgraph_sloc0_1_0,c
	jnc	00104$
00103$:
	clr	_isgraph_sloc0_1_0
	sjmp	00105$
00104$:
	setb	_isgraph_sloc0_1_0
00105$:
	mov	c,_isgraph_sloc0_1_0
	clr	a
	rlc	a
	mov	r6,a
	mov	r7,#0x00
